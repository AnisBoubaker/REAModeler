...
public class ResourceUpdateFeature extends AbstractUpdateFeature {
	...
	public IReason updateNeeded(IUpdateContext context) {
        ...
        if (pictogramElement instanceof ContainerShape) {
            ...
            for (Shape shape : cs.getChildren()) {
                if (shape.getGraphicsAlgorithm() instanceof Text
                		...
                		&& Graphiti.getPeService().getPropertyValue(shape, "shape-id").equals("reaResource_name")) {
        ...
        if (bo instanceof Resource) {
            Resource resource = (Resource) bo;
            businessName = resource.getName();
        }
        ...
        if (updateNameNeeded) {
            return Reason.createTrueReason("Resource is out of date");
        } else {
